  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border bg-background/85 backdrop-blur-xl">
      ...
      <div className="mx-auto flex h-16 max-w-[1440px] items-center justify-between px-6">
        <Link to="/" className="flex items-center gap-2.5" aria-label="TOC Sat Bantek Home">
          <img src={logo} alt="TOC Sat Bantek" width={44} height={44} className="h-11 w-11 drop-shadow-[0_0_12px_oklch(0.82_0.18_80_/_0.5)]" />
        </Link>
